...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.default = _default;var _regenerator = _interopRequireDefault(__webpack_require__(/*! ./node_modules/@babel/runtime/regenerator */ 27));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) {try {var info = gen[key](arg);var value = info.value;} catch (error) {reject(error);return;}if (info.done) {resolve(value);} else {Promise.resolve(value).then(_next, _throw);}}function _asyncToGenerator(fn) {return function () {var self = this,args = arguments;return new Promise(function (resolve, reject) {var gen = fn.apply(self, args);function _next(value) {asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value);}function _throw(err) {asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err);}_next(undefined);});};}function _default(_x) {return _ref.apply(this, arguments);}function _ref() {_ref = _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee(callback) {var _this = this;var index, item, v, result, s, text, m;return _regenerator.default.wrap(function _callee$(_context) {while (1) {switch (_context.prev = _context.next) {case 0:
            //获取需要加载的选项
            index = parseInt(this.pageData.findIndex(function (item) {return item.areaName == _this.selectarea;}));
            console.log(index);
            //停止加载
            if (!(this.pageData[index].text == "到底了")) {_context.next = 4;break;}return _context.abrupt("return");case 4:
            ...
            v.isLoading = true;v.text = "加载中...";
            this.$set(this.pageData, index, v);

            //获取数据
            _context.next = 14;return new Promise(function (resolve, reject) {
              callback(resolve, reject);
            });case 14:result = _context.sent;
            //隐藏loading框
            wx.hideLoading();
            ...
            m.text = text;
            this.$set(this.pageData, index, m);case 24:case "end":return _context.stop();}}}, _callee, this);}));return _ref.apply(this, arguments);}
...
/***/ 15:
/*!*******************************************!*\
  !*** E:/workspace/小程序/App/store/index.js ***!
  \*******************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var store = new _vuex.default.Store({
  ...
  actions: {
    // lazy loading openid
    loginIn: function loginIn(_ref) {var commit = _ref.commit,state = _ref.state;var userinfo = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
...
/***/ 17:
/*!*********************************************!*\
  !*** E:/workspace/小程序/App/utils/request.js ***!
  \*********************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
/* WEBPACK VAR INJECTION */(function(uni) {Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _base = _interopRequireDefault(__webpack_require__(/*! ./base */ 18));
...
//发送数据
var sendRequest = function sendRequest(url) {var params = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};var method = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : "POST";
  //将方法转为小写
  method = method.toUpperCase();
  return new Promise(function (resolve, reject) {
    uni.request({
      url: _base.default.apiHost + url,
      method: method,
      data: params,
      header: {
...
//获取AccessToken
function getAccessToken() {var callback = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : function () {};
  uni.login({
  ...
  return new Promise(function (resolve, reject) {
    uni.checkSession({
      success: function success() {
        ...
        _index.default.dispatch("loginIn", { username: "dzf" });
        resolve();
      },
      fail: function fail() {
...

{
  ...
  getAccessToken: getAccessToken };exports.default = _default;
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(/*! ./node_modules/@dcloudio/uni-mp-weixin/dist/index.js */ 1)["default"]))
...
/***/ 18:
/*!******************************************!*\
  !*** E:/workspace/小程序/App/utils/base.js ***!
  \******************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 19:
/*!***********************************************!*\
  !*** E:/workspace/小程序/App/utils/uploadImg.js ***!
  \***********************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 4:
/*!***************************************!*\
  !*** E:/workspace/小程序/App/pages.json ***!
  \***************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 66:
/*!***************************************************************!*\
  !*** E:/workspace/小程序/App/wxcomponents/vant/dialog/dialog.js ***!
  \***************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 7:
/*!********************************************************!*\
  !*** E:/workspace/小程序/App/pages.json?{"type":"style"} ***!
  \********************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _default = { "pages": { "pages/index/index/index": { "navigationBarTitleText": "首页", "navigationBarBackgroundColor": "#38A472", "navigationBarTextStyle": "white", "backgroundColor": "#38A472" }, "pages/me/me/me": { "navigationBarTitleText": "我的" }, "pages/cate/cate/cate": { "navigationBarTitleText": "分类" }, "pages/cart/cart/cart": { "navigationBarTitleText": "购物车" }, "pages/me/address/address": { "navigationBarTitleText": "添加地址" }, "pages/me/address_list/address_list": { "navigationBarTitleText": "收货地址管理" }, "pages/index/search/search": { "navigationBarTitleText": "搜索商品", "navigationBarBackgroundColor": "#38A472", "navigationBarTextStyle": "white" } }, "globalStyle": { "navigationBarTextStyle": "black", "navigationBarTitleText": "uni-app", "navigationBarBackgroundColor": "#fff", "backgroundColor": "#fff" } };exports.default = _default;

/***/ }),

/***/ 8:
/*!*******************************************************!*\
  !*** E:/workspace/小程序/App/pages.json?{"type":"stat"} ***!
  \*******************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _default = { "appid": "__UNI__E998214" };exports.default = _default;
